...
type EvidenceDetail = {
  ...
  year?:number; publication?:string; document_type?:string; publication_type?:string; review_status:string; abstract?:string; normalized_doi?:string;
